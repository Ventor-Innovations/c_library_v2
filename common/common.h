...
#define MAVLINK_COMMON_XML_HASH 8163876031988850198
...
/** @brief Distance measurement type to use for setting the relative altitude of the vehicle to the current AGL with MAV_CMD_DO_SET_REL_ALT_FROM_DIST_SENSOR. */
#ifndef HAVE_ENUM_REL_ALT_FROM_DIST_MEASURE_TYPE
#define HAVE_ENUM_REL_ALT_FROM_DIST_MEASURE_TYPE
typedef enum REL_ALT_FROM_DIST_MEASURE_TYPE
{
   REL_ALT_FROM_DIST_MEASURE_TYPE_HOR_DIST=0, /* Measure distance during a horizontal travel distance in meters. | */
   REL_ALT_FROM_DIST_MEASURE_TYPE_TIME=1, /* Measure distance over a period of time in seconds. | */
   REL_ALT_FROM_DIST_MEASURE_TYPE_SAMPLE_NUM=2, /* Measure distance over a number of samples. | */
   REL_ALT_FROM_DIST_MEASURE_TYPE_ENUM_END=3, /*  | */
} REL_ALT_FROM_DIST_MEASURE_TYPE;
#endif
